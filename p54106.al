OBJECT Page 54106 Contract Card
{
  ...
  PROPERTIES
  {
    ...
    ActionList=ACTIONS
    {
      ...
      { 1101495026;2 ;Action    ;
                      CaptionML=[CSY=�etn� polo�ky - NAV - CRM;
      ...
      { 1000000037;1 ;Action    ;
                      CaptionML=[CSY=Polo�ky z�kazn�ka za smlouvu;
      ...
      { 1000000049;2 ;Action    ;
                      ...
                      OnAction=VAR
                                 CustLELcl@1000000000 : Record 21;
                                 NotEndedContract@1000000002 : TextConst 'CSY=Smlouvu nelze ukon�it.;ENU=Contract is not allow to end.';
      ...
      { 1000000081;2 ;Action    ;
                      CaptionML=[CSY=P�rovat nep�i�azen� platby;
                                 ENU=Apply Payment;
                                 RUS=�ਬ����� �����];
                      OnAction=VAR
                                 CustLELcl@1000000000 : Record 21;
  ...
  CONTROLS
  {
    ...
    { 1000000005;2;Field  ;
                CaptionML=[CSY=Nomin�ln� hodnota;
                           ENU=Initial NV;
                           RUS=��砫쭠� ������ �⮨�����];
    ...
    { 1000000085;2;Field  ;
                CaptionML=[CSY=�rok z prodlen� - uhrazeno k datu;
    ...
    { 1000000084;2;Field  ;
                CaptionML=[CSY=�rok z prodlen� posledn� spl. - uhrazeno k datu;
    ...
    { 1000000071;2;Field  ;
                CaptionML=[CSY=Pokuta posledn� spl. - uhrazeno k datu;
    ...
    { 1000000070;2;Field  ;
                CaptionML=[CSY=Po�et dn� po splatnosti;
  ...
  CODE
  {
    VAR
      ...
      CommuOKTxt@1000000003 : TextConst 'CSY=Komunikace se CRM prob�hla bez probl�m�.;ENU=CRM communication processed.';
      CommuErrTxt@1000000004 : TextConst 'CSY=Komunikace se CRM skon�ila s chybou %1.;ENU=CRM communication ended with mistake %1.';
      CRMURL@1000000005 : Text[1024];
      CRMStatus@1101495000 : Text[30];
      Text50000@1101495003 : TextConst 'ENU=Recorded in General Journal! Open the Journal?;RUS=����ᠭ� � 䨭. ��ୠ�! ������ ��ୠ�?';
    ...
    BEGIN
    {
      ...
      2017.04.19 KDV
        ���� APR, "��砫쭠� ���" �a ���a��� ��饥
      2017.05.02
        ����� ���� "Consent (Claim Assign. Agr.)" �a ���a��� General
      2017-06-01 SAI
        � CreatePaySchedNAVCRM ��������� ���������� ���� Created by Object � ⠡��� 54110.
      AKAM 220617
        ��������� ����� ���� CRM ����� ����ࠪ�
      AKAM 030717
        ���� ������ �⮨����� ��२������� � ��砫쭠� ������ �⮨�����
      ...
      2018.01.08 KDV ���� Default, Default Date
      AKAM 270718
        ������ ����ࠪ�/����樨/ �������� ���� �㭪� ���� "���஡�� ����樨 ������"
      PC AKAM 20180813
        ��������� ���� Manual Control (��筮� ����஫�)
      PC AKAM 160818
        ��������� ������� ����஫�. �� ������� ��������� ���� �� ����뢠�� DRPS, ��筮� ����஫�.
      2019-04-03 SAI
        ������� �맮� �㭪樨 NewUnifiedMathL.GetTotalAgentCommissionRate(Rec) - �ਢ���� � ᮮ⢥��⢨� � ��⨬���஢���� ��
      2019-06-10 SAI
        ��ࠢ��� ������ �맮� �㭪樨 ᮧ����� ���. ���
      2019-10-01 LAV >
        Premium
      2019.12.11 ����� ���� "PTI Amount"
      2020.03.12 ����� ��㯯� "��������� ���."
      ...
      03.08.20 Stefa ���客��
        ...
        CurrPage.Insurance
          were added (��饥) (Editable = FALSE)

      25.08.20 Stefa New Product Type "Profi Light"
        CurrPage."Initial Installment Due Date 2" was added (��饥) (Editable = FALSE)

      19.10.20 Stefa New Product Type "Profi Light"
        CurrPage."APR Profi Light" was added (��饥) (Editable = FALSE)

      22.10.20 Stefa NAV-404
        CurrPage."Comission CC" was added (��饥) (Editable = FALSE) - ����� FlowField "Commission CC"
    }
    END.
  }
}
